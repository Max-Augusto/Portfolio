...
const DICTIONARY: Record<Language, Record<string, string>> = {
  pt: {
    // Navigation / Header
    'nav.about': 'Sobre',
    'nav.what_i_do': 'Atuação',
    'nav.experience': 'Experiência',
    'nav.projects': 'Projetos',
    'nav.skills': 'Skills',
    'nav.topology': 'Lab Rede',
    'nav.terminal': 'Terminal',
    'nav.contact': 'Contato',
    'header.operator_status': 'SISTEMAS OPERACIONAIS',
    'header.uptime': '99.9% UPTIME',
    'header.search': 'Buscar',
    'header.role': 'Analista de Suporte N2 & SRE / Backend Developer',
    ...
    'header.nav_title': 'SEÇÕES DO PORTFÓLIO',
    'header.nav_hint': 'Clique para navegar diretamente',
    'dock.more': 'Mais',
    'drawer.title': 'SEÇÕES DO PORTFÓLIO',
    'drawer.subtitle': 'Selecione qualquer um dos 8 módulos',
    'drawer.active': 'Ativo',
  ...
  en: {
    ...
    'header.role': 'Support Analyst N2 & SRE / Backend Developer',
    ...
    'header.nav_title': 'PORTFOLIO SECTIONS',
    'header.nav_hint': 'Click to navigate directly',
    'dock.more': 'More',
    'drawer.title': 'PORTFOLIO DIRECTORY',
    'drawer.subtitle': 'Select any of the 8 modules',
